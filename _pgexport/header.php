...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <link rel="mask-icon" href="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/favicon/safari-pinned-tab.svg" color="#77bcb4">
        <meta name="msapplication-TileColor" content="#77bcb4">
        <meta name="theme-color" content="#f8f5ed">
        <link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>">
        <meta content="Pinegrow Web Editor" name="generator">
        <?php wp_head(); ?>
    </head>
    <body class="bg-pale_buffet-100 font-sans overflow-x-hidden relative text-neutral_buffet-600 <?php echo implode(' ', get_body_class()); ?>" data-pg-ia='{"l":[{"trg":"load","a":"fadeIn"}]}' data-pg-ia-hide>
