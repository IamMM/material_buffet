...
<?php get_header(); ?>
        ...
        <main id="main" class="mx-auto overflow-hidden relative xl:w-8/12 2xl:w-7/12 text-center">
            <div style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/farbe.jpeg'); background-position: center center; background-size: cover; height: 250px;" class="flex flex-wrap-reverse mb-5 relative">
                <h1 class="text-6xl text-pastel_buffet-100 md:absolute md:bottom-0 md:inset-x-0 md:mb-10 md:text-8xl"><?php _e( 'das konzept', 'buffet_1_punkt_null' ); ?></h1>
            ...
            <div class="container mb-20 mx-auto relative xl:w-8/12 2xl:w-7/12"> 
                ...
                <div class="flex flex-wrap items-start mb-4 px-4"> 
                    ...
                    <div class="md:w-2/3 mb-10 mx-auto"> 
                        <p class="mb-5 text-2xl"><?php _e( 'wenn Materialien nicht entsorgt und für Andere nicht neu produziert werden müssen? Das haben wir uns auch gefragt und dir mal folgende Beispiele berechnet. Wissenschaft können wir nämlich auch.', 'buffet_1_punkt_null' ); ?></p> 
                        <p class="mb-5 text-2xl"><?php _e( 'Zum Vergleich: Pro Jahr bindet eine Buche ca. 12,5 Kilogramm CO2. Du müsstest also 80 Bäume pflanzen, um 1 Tonne CO2 durch Bäume wieder zu kompensieren.', 'buffet_1_punkt_null' ); ?></p>
                        <p class="mb-5 text-2xl"><?php _e( '*Kilogramm CO2-Äquivalent = Masseinheit zur Vereinheitlichung der Klimawirkung der unterschiedlichen Treibhausgase.', 'buffet_1_punkt_null' ); ?></p> 
                    </div>
