...
<?php get_header(); ?>
        ...
        <header class="bg-bg-100 bg-opacity-90 sticky top-0 w-full z-30 xl:mx-auto"> 
            <nav class="lg:flex lg:flex-wrap lg:mx-auto xl:w-8/12 2xl:w-7/12">
        ...
        <main id="main" class="lg:container lg:mx-auto overflow-hidden relative xl:w-8/12 2xl:w-7/12">
            ...
            <div style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/buffet.jpg'); background-position: center center; background-size: cover; height: 450px;<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>" class="flex flex-col-reverse relative">
                <h1 class="flex text-7xl text-white lg:absolute lg:text-9xl"><?php _e( 'material', 'buffet_1_punkt_null' ); ?><br><?php _e( 'buffet', 'buffet_1_punkt_null' ); ?></h1>
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/logo/MB_Icon_White-01.png" class="flex h-52 w-52 z-20 lg:hidden" data-pg-ia="{&quot;l&quot;:[{&quot;trg&quot;:&quot;now&quot;,&quot;a&quot;:&quot;rollIn&quot;},{&quot;trg&quot;:&quot;mouseenter&quot;,&quot;a&quot;:&quot;swing&quot;}]}">
            </div>
        ...
        <section class="overflow-x-hidden py-20 relative" id="speisekarte"> 
            <div class="container mx-auto relative z-0 xl:w-8/12 2xl:w-7/12"> 
                ...
                <div class="flex flex-wrap mb-20 text-center -ml-4">
                    <div class="w-6/12 w-full md:w-4/12">
                        <div data-tooltip-target="tooltip-holz" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white duration-500 ease-in-out h-40 hover:scale-110 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/holz.jpeg'); background-size: cover; background-position: center center;"></span>
                            <p class="font-bold mb-2 text-xl"><?php _e( 'Holz', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-holz" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
                    ...
                    <div class="w-full w-6/12 md:w-4/12">
                        <div data-tooltip-target="tooltip-metall" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white h-40 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60 duration-500 ease-in-out hover:scale-110" style="background-size: cover; background-position: center center; background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/metall.jpeg');"></span>
                            <p class="font-bold mb-2 text-xl"><?php _e( 'Metall', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-metall" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
                    ...
                    <div class="w-full w-6/12 md:w-4/12">
                        <div data-tooltip-target="tooltip-farbe" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white h-40 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60 duration-500 ease-in-out hover:scale-110" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/farbe.jpeg'); background-size: cover; background-position: center center;"></span>
                            <p class="font-bold mb-2 text-xl"><?php _e( 'Farben', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-farbe" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
                    ...
                    <div class="w-full w-6/12 md:w-4/12">
                        <div data-tooltip-target="tooltip-elektro" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white h-40 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60 duration-500 ease-in-out hover:scale-110" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/electro.jpeg'); background-size: cover; background-position: center center;"></span> 
                            <p class="font-bold mb-2 text-xl"><?php _e( 'Kabel &amp; Lampen', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-elektro" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
                    ...
                    <div class="w-full w-6/12 md:w-4/12">
                        <div data-tooltip-target="tooltip-stoffe" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white h-40 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60 duration-500 ease-in-out hover:scale-110" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/stoffe.jpeg'); background-size: cover; background-position: center center;"></span> 
                            <p class="font-bold mb-2 text-xl"><?php _e( 'Stoffe', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-stoffe" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
                    ...
                    <div class="w-full w-6/12 md:w-4/12">
                        <div data-tooltip-target="tooltip-etc" data-tooltip-placement="bottom" data-tooltip-style="light" class="cursor-pointer"> 
                            <span class="bg-white h-40 inline-block my-4 p-12 rounded-full w-40 md:h-60 md:w-60 duration-500 ease-in-out hover:scale-110" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/andereLeckerein.jpeg'); background-size: cover; background-position: center center;"></span> 
                            <p class="font-bold mb-2 text-xl"><?php _e( 'und andere Leckereien', 'buffet_1_punkt_null' ); ?></p> 
                        </div>
                        <div id="tooltip-etc" role="tooltip" class="tooltip absolute z-10 inline-block bg-white font-medium shadow-sm text-gray-900 border border-gray-200 py-2 px-3 text-sm rounded-lg opacity-0 invisible">
                            <ol class="text-left">
                                <li>
        ...
        <section class="mx-auto overflow-x-hidden xl:w-8/12 2xl:w-7/12" id="support"> 
            <div class="container mx-auto px-4 relative text-left" style="background-image: url('<?php echo esc_url( get_template_directory_uri() ); ?>/assets/shapes/Form_15_blue#1.png');"> 
                ...
                <h2 class="font-bold mb-4 relative text-3xl md:text-5xl w-max"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/textures/Element9.png" class="-right-32 -top-10 absolute"/><?php _e( 'Dont´t waste it - taste it!', 'buffet_1_punkt_null' ); ?></h2> 
        ...
        <section class="py-20 relative text-center 2xl:mx-auto 2xl:w-9/12" id="partnerInnen"> 
        ...
        <section class="flex flex-wrap-reverse items-center mx-auto relative lg:flex-wrap mb-10 xl:w-9/12 2xl:w-7/12" id="lageplan"> 
            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/bilder/anfahrt.png" class="mx-auto w-8/12 lg:mx-0 lg:relative lg:w-7/12 xl:block xl:left-20">
            <div class="w-full lg:absolute lg:bottom-0 lg:right-0 lg:w-6/12 xl:w-5/12"> 
                <div class="bg-white m-5 lg:m-0 p-5 shadow-xl z-10 sm:p-16 lg:relative">
                    ...
                    <p class="mb-2"><?php _e( 'Zwei Freitage im Monat von 12-18 Uhr&nbsp;', 'buffet_1_punkt_null' ); ?></p>
                    <p class="mb-2"><?php _e( 'Ehemalige Kantine in der Diezmannstraße 20, Haus 3.', 'buffet_1_punkt_null' ); ?></p>
