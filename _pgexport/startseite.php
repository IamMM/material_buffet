...
<?php get_header(); ?>
        ...
        <section class="py-20 relative md:text-center 2xl:mx-auto 2xl:w-9/12" id="partnerInnen"> 
            <img class="absolute left-0 top-10" data-pg-ia-scene='{"l":[{"a":{"l":[{"t":"","l":[{"t":"set","p":0,"d":0,"l":{"autoAlpha":0,"transformOrigin":"left bottom","rotationZ":-30},"e":"Power1.easeOut"},{"t":"tween","p":0,"d":1,"l":{"autoAlpha":1,"transformOrigin":"left bottom","rotationZ":0},"e":"Power1.easeOut"}]}]}}]}' src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/textures/Element11.png">
            <div class="container mx-auto px-4 relative"> 
                ...
                <div class="flex flex-wrap items-center justify-around mt-20 md:space-x-10 md:justify-around md:text-center" id="logos"> 
